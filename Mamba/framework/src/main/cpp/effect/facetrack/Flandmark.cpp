...
//		{
//			LOGE("open flandmark model data failed: %s", filename);
//			exit(1);
//		}
//
...
//			LOGD("model->data.options.PSIG_ROWS[%d] = %d; model->data.options.PSIG_COLS[%d] = %d; ",
//				idx, model->data.options.PSIG_ROWS[idx], idx, model->data.options.PSIG_COLS[idx]);
//		}
//
//		// write model->W
//		LOGI("Writing model->W to file... ");
//		if (fwrite(model->W, model->W_ROWS * sizeof(double), 1, fout) != 1)
//		{
//			fclose(fout);
//			LOGE("write flandmark model : %s", filename);
//			exit(1);
//		}
//
//		// write model->mapTable
//		LOGI("Writing model->data.mapTable to file... ");
//		if (fwrite(model->data.mapTable, model->data.options.M * 4 * sizeof(int), 1, fout) != 1)
//		{
//			fclose(fout);
//			LOGD("Error writing file %s", filename);
//			exit(1);
//		}
//
//		// write model->data.lbp ---------------------------------------------------
//		LOGI("Writing model->data.lbp to file... ");
//		for (int idx = 0; idx < model->data.options.M; ++idx)
//		{
//			//printf("lbp[%d]... ", idx);
//			// lbp{idx}.winSize
...
//		LOGI("Writing model->data.options.S to file... ");
...
//		LOGI("Checking mode->data.options.M...");
//		flag = true;
...
//		}
//		flag == true ? LOGI("passed. ") : LOGI("NOT passed.");
//		if (!flag)
//		{
//			return ERROR_M;
//		}
...
//		LOGI("Checking mode->data.options.bw...");
//		flag = true;
...
//		LOGI("Checking mode->data.options.bw_margin...");
//		flag = true;
...
//		LOGI("Checking model->data.mapTable... ");
//		flag = true;
//		for (int i = 0; i < M * 4; ++i)
//		{
...
//				}
//			}
//			flag == true ? LOGI("passed. ") : LOGE("NOT passed.");
//			if (!flag)
//			{
...
//		LOGI("Checking model->data.options.S... ");
//		flag = true;
//		for (int i = 0; i < 4 * M; ++i)
//		{
...
//			}
//			flag = true;
//			LOGI("Checking model->data.options.PsiGS%d", psig_idx);
//			LOGI("options.PSIG_ROWS[%d]; options.PSIG_COLS[%d]... ", psig_idx, psig_idx);
...
//				flag = false;
//			}
//			flag == true ? LOGE("passed. ") : LOGE("NOT passed.");
//			if (!flag)
//			{
...
//					{
//						flag = false;
//						LOGE("\nPsiGS%d[%d] =  %d; %d", psig_idx, idx, PsiGi[idx].disp[i], PsiGiTst[idx].disp[i]);
//					}
//				}
//			}
//			flag == true ? LOGI("passed. ") : LOGI("NOT passed.");
...
//		if (Features == NULL)
//		{
//			LOGE("Not enough memory for LBP features.");
//			exit(1);
//		}
...
//		if (win == NULL)
//		{
//			LOGE("Not enough memory for cropped_window.");
//			exit(1);
//		}
//
