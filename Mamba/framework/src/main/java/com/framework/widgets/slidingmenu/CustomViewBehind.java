package com.framework.widgets.slidingmenu;
...
public class CustomViewBehind extends ViewGroup {
	...
	/**
	 * 设置滑动的位置
	 * @param mMarginThreshold
     */
	public void setMarginThreshold(int mMarginThreshold) {
		this.mMarginThreshold = mMarginThreshold;
	}
